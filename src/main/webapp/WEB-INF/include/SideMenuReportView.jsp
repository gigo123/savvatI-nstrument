				...
				<div class="col-3">
					<div class="user-dashboard-tab flex-column flex-md-row">
						<div class="user-dashboard-tab__head nav flex-md-column"
							...
							href="./operation">весь интсрумент</a>
							<a class="nav-link ${page!=null?page.equals("location")?"active": "":""}"
							 href="./addlocation">по мету хранения</a> <a class="nav-link ${page!=null?page.equals("box")?"active": "":""}"
							 href="./addbox"
								aria-selected="true">по иснтрументу</a> 
						</div>
					</div>
				</div>