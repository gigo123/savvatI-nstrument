...
public class CreateOutDoc {
	...
	public ModelAndView getOutDocCF() {
		...
		ModelAndView model = new ModelAndView("CreateOutDoc");
		model.addObject("exDocWEBList", exDocWEBList);
		model.addObject("page", "outdoc");
		return model;
	}
	...
	public String postOutDocCF(@ModelAttribute("exDocWEBList") @Validated ExDocWEBList exDocWEBList,
		...
		String message;
		message = ControllersCheckWDoc.createExDocUnwrap(exDocWEBList, DocType.OUTDOC);
